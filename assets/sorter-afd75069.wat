(module
 ...
 (data (i32.const 304) "\04\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00!\t\00\00\02\00\00\00")
 (table $0 1 funcref)
 (global $~lib/rt/tlsf/ROOT (mut i32) (i32.const 0))
 (global $~lib/ASC_LOW_MEMORY_LIMIT i32 (i32.const 0))
 (global $~lib/rt/tlsf/collectLock (mut i32) (i32.const 0))
 (global $~lib/gc/gc.auto (mut i32) (i32.const 1))
 (global $input/Int32Array_ID i32 (i32.const 3))
 ...
 (export "Int32Array_ID" (global $input/Int32Array_ID))
 (export "sort" (func $input/sort))
 ...
 (func $input/swap (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  local.get $0
